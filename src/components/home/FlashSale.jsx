...
import { FaArrowLeft, FaArrowRight, FaRegEye, FaRegHeart, FaStar } from "react-icons/fa"
...
const FlashSale = () => {
    ...
    return (
        <CommonHeading heading={"Flash Sales"} subHeading={"Today's"}>
    ...
    return (
        <div className="max-w-[270px] mx-auto px-2 sm:px-1">
            ...
            <div className="pt-3 sm:pt-4 px-1">
                <h2 className={`text-sm sm:text-base leading-[20px] sm:leading-[24px] pb-2 line-clamp-2 ${popins.className}`}>
                    {title}
                </h2>
                <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                    <span className={`text-sm sm:text-base text-[#DB4444] leading-[20px] sm:leading-[24px] font-semibold ${popins.className}`}>
                        ${oldPrice}
                    </span>
                    <del className={`text-sm sm:text-base leading-[20px] sm:leading-[24px] text-gray-500 ${popins.className}`}>
                        ${price}
                    </del>
                </div>
            </div>
